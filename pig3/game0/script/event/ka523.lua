Talk(0, "哇！這兒有那麼多乞丐，我身上的零錢可能不太夠．", 0, 1);
Talk(93, "閣下別驚慌，我們群丐在這裡聚聚，不會向你乞討的．", 93, 0);
Talk(0, "一大群乞丐聚在這裡，你們該不會是丐幫吧？", 0, 1);
Talk(93, "正是．", 93, 0);
Talk(0, "久聞丐幫乃天下第一大幫，人數之眾，為武林之最．小弟行走江湖，說什麼也得認識一下丐幫的英雄好漢．", 0, 1);
Talk(93, "閣下好說．", 93, 0);
Talk(0, "不知這位大哥是否可替我引見一下貴幫幫主．", 0, 1);
Talk(93, "想見我們幫主，那也得是個英雄好漢才行．", 93, 0);
Talk(0, "怎樣才算是個英雄好漢？", 0, 1);
Talk(93, "你說呢．", 93, 0);
Talk(0, "嗯．．．．．．．．．．．．．．．．．．．．久聞丐幫打狗陣威力無比，在下不才，想與各位切磋切磋．", 0, 1);
if TryBattle(82) == true then goto label0 end;
    ...
    LightScene();
    Talk(93, "閣下這樣的功夫，似乎不配見我家幫主．", 93, 0);
    exit();
::label0::
    ...
    LightScene();
    Talk(93, "閣下功夫不錯，竟破了我丐幫之打狗陣法．喬幫主就在裡面，請進，我家幫主一定很高興認識你．", 93, 0);
    AddRepute(2);
exit();
