...
Talk(0, "門總算開了，終於可以回去了．**可是，心裡面好像怪怪的，總覺得好像少了件什麼事．．．．．．", 0, 1);
if JudgeEthics(0, 0, 50) == true then goto label0 end;
    ...
    SetRoleFace(1);
    LightScene();
    Talk(0, "我就知道，每次在結局前，總是少不了一場大混戰．", 0, 1);
    Talk(67, "小子，你武功那麼強，一定是從”十四天書”中領悟到什麼奧妙．", 67, 0);
    Talk(71, "快將它說出來，否則．．．", 71, 0);
    Talk(0, "否則怎樣？你們個個都是小俠我的手下敗將，還想怎樣？", 0, 1);
    Talk(22, "一個人打不過你，那十個人呢？", 22, 0);
    Talk(0, "不會吧！你們個個都是武林中有名的夙宿，不會聯合起來打我一個人吧？傳了出去，你們以後怎麼做人？", 0, 1);
    Talk(19, "事到如此，還管得了這麼許多嗎？", 19, 0);
    Talk(51, "何況，把你殺了後，也沒人會傳出去了．", 51, 0);
    Talk(62, "別說廢話了．動手吧！", 62, 0);
    if TryBattle(133) == true then goto label1 end;
        Dead();
        exit();
::label1::
        LightScene();
        Talk(60, "哼！算你厲害．我們走．", 60, 0);
        DarkScene();
        ...
        LightScene();
        PlayWave(23);
        Talk(0, "總算料理完畢了．咦！好像又有聲音．", 0, 1);
        DarkScene();
        SetSceneMap(-2, 1, 18, 25, 4062);
        SetSceneMap(-2, 1, 18, 26, 4062);
        LightScene();
        Talk(0, "怎麼門又關起來了．這次大概真的結束了．走吧，我得趕快了．", 0, 1);
        exit();
::label0::
        Talk(57, "小子，你想就這樣子走了嗎？", 57, 0);
        Talk(0, "真的發生事情了．", 0, 1);
        DarkScene();
        ...
        LightScene();
        Talk(0, "我就知道，每次在結局前，總是少不了一場大混戰．", 0, 1);
        Talk(69, "在這武林中，你幹下了多少壞事．", 69, 0);
        Talk(3, "看看你的道德指數吧，你都幹了些什麼？", 3, 0);
        Talk(55, "練武是為了什麼？行俠仗義，濟弱扶傾的目的你都忘了嗎？", 55, 0);
        Talk(64, "你在武林中混了這麼久，盡學一些壞東西．", 64, 0);
        Talk(56, "是我們錯了，沒能把你教好．", 56, 0);
        Talk(70, "但我們也不能讓你就這樣一走了之．", 70, 0);
        Talk(50, "別怪我們出手太重，你留在這世間也只是個禍害．", 50, 0);
        Talk(69, "動手吧．", 69, 0);
        Talk(70, "阿彌陀佛！", 70, 0);
...
::label2::
            LightScene();
            Talk(55, "我們已經盡力了，還是無法消滅你這禍害．", 55, 0);
            Talk(70, "阿彌陀佛！這是眾生的浩劫呀！", 70, 0);
            Talk(69, "殺不了你這個大魔頭．唉！或許是天意吧！我們走吧．", 69, 0);
            DarkScene();
            ModifyEvent(-2, 25, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
            ModifyEvent(-2, 26, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
            ModifyEvent(-2, 27, 0, 0, -1, -1, -1, -1, -1, -1, -2, -2, -2);
