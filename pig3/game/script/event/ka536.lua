DarkScene();
SetSceneMap(56, 1, 38, 29, 2784);
SetSceneMap(56, 1, 39, 29, 2786);
SetSceneMap(56, 1, 40, 29, 2784);
SetSceneMap(56, 1, 41, 29, 2786);
SetSceneMap(56, 1, 38, 31, 8358);
SetSceneMap(56, 1, 39, 31, 8366);
SetSceneMap(56, 1, 36, 31, 8364);
SetSceneMap(56, 1, 38, 33, 8434);
SetSceneMap(56, 1, 27, 16, 7264);
LightScene();
Talk(26, "&&，你果然來了。", -2, 1, 0, 0);
Talk(0, "那是自然，大丈夫言而有信。**咦？前面是……？", -2, 0, 0, 0);
SceneFromTo(28, 15, 38, 33);
Talk(325, "張兄弟，你將這兩人拿下了，可別傷他們性命。我先行一步，咱們京城見……", -2, 1, 0, 0);
Talk(358, "……", -2, 1, 0, 0);
Talk(326, "哪裡跑！", -2, 0, 0, 0);
Talk(327, "龍哥，咱們追！", -2, 0, 0, 0);
SceneFromTo(38, 33, 28, 15);
Talk(412, "是杭州那兩人！他們也來搶刀？", -2, 0, 0, 0);
Talk(26, "糟了，看來想要寶刀的不止我們。&&少俠，你去追那鏢頭，我去看鏢車。", -2, 1, 0, 0);
Talk(0, "好！", -2, 0, 0, 0);
DarkScene();
SetSceneMap(56, 1, 38, 29, 0);
SetSceneMap(56, 1, 39, 29, 0);
SetSceneMap(56, 1, 40, 29, 0);
SetSceneMap(56, 1, 41, 29, 0);
SetSceneMap(56, 1, 38, 31, 0);
SetSceneMap(56, 1, 39, 31, 0);
SetSceneMap(56, 1, 36, 31, 0);
SetSceneMap(56, 1, 38, 33, 0);
SetSceneMap(56, 1, 27, 16, 0);
SetSceneMap(56, 1, 27, 44, 8434);
SetScenePosition2(27, 46);
SetRoleFace(0);
LightScene();
...
if TryBattle(24) == true then goto label0 end;
    ...
    exit();
::label0::
    SetSceneMap(56, 1, 27, 44, 5428);
    SetSceneMap(56, 1, 25, 44, 8438);
    SetSceneMap(56, 1, 25, 45, 8436);
    LightScene();
    ...
    Talk(421, "糟了！", -2, 0, 0, 0);
    DarkScene();
    SetSceneMap(56, 1, 27, 42, 8440);
    SetSceneMap(56, 1, 28, 42, 7266);
    LightScene();
...
::label1::
        SetSceneMap(56, 1, 27, 44, 0);
        SetSceneMap(56, 1, 26, 42, 8442);
        LightScene();
        ...
        DarkScene();
        SetSceneMap(56, 1, 27, 42, 7270);
        SetSceneMap(56, 1, 25, 42, 0);
        LightScene();
...
::label2::
            ...
            DarkScene();
            SetSceneMap(56, 1, 28, 42, 0);
            SetSceneMap(56, 1, 27, 42, 0);
            SetSceneMap(56, 1, 25, 44, 0);
            SetSceneMap(56, 1, 25, 45, 0);
