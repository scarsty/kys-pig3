...
SetSceneMap(66, 1, 15, 16, 0);
Talk(416, "李姑娘，李姑娘？余魚同你這混賬！", -2, 0, 0, 0);
DarkScene();
SetScenePosition2(16, 16);
LightScene();
Talk(54, "&&少俠？？", -2, 1, 0, 0);
...
::label0::
    ...
    SetSceneMap(53, 1, 29, 26, 8796);
    SetSceneMap(53, 1, 28, 27, 7172);
