...
if TryBattle(54) == true then goto label0 end;
    ...
    exit();
::label0::
    SetSceneMap(49, 1, 30, 18, 0);
    SetSceneMap(49, 1, 26, 18, 0);
    SetSceneMap(49, 1, 27, 18, 0);
    SetSceneMap(49, 1, 28, 18, 0);
    SetSceneMap(49, 1, 29, 18, 0);
    SetSceneMap(49, 1, 30, 19, 0);
    SetSceneMap(49, 1, 26, 19, 0);
    SetSceneMap(49, 1, 27, 19, 0);
    SetSceneMap(49, 1, 28, 19, 0);
    SetSceneMap(49, 1, 29, 19, 0);
    SetScenePosition2(28, 16);
    SetRoleFace(0);
    LightScene();
