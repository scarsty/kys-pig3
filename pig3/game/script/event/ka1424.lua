...
::label1::
            instruct_50(17, 0, 0, 166, 76, 0, 0);
            instruct_50(32, 0, 0, 6, 0, 0, 0);
...
::label8::
                                    ...
                                    if CheckJumpFlag() == true then goto label9 end;
                                        ...
                                        if JudgeSexual(0) == true then goto label10 end;
::label9::
