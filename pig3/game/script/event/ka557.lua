...
::label0::
    ...
    DarkScene();
    SetSceneMap(64, 1, 23, 25, 0);
    SetSceneMap(64, 1, 35, 23, 0);
    SetSceneMap(64, 1, 33, 21, 0);
    SetSceneMap(64, 1, 31, 21, 0);
    SetSceneMap(64, 1, 30, 21, 0);
    SetSceneMap(64, 1, 28, 20, 0);
    SetSceneMap(64, 1, 27, 21, 0);
    SetSceneMap(64, 1, 26, 21, 0);
    SetSceneMap(64, 1, 25, 20, 0);
    SetSceneMap(64, 1, 24, 23, 0);
    SetSceneMap(64, 1, 35, 25, 0);
    SetRoleFace(3);
    LightScene();
    ...
    DarkScene();
    SetSceneMap(64, 1, 29, 28, 0);
    SetSceneMap(64, 1, 34, 31, 0);
    SetSceneMap(64, 1, 25, 27, 0);
    SetSceneMap(64, 1, 33, 27, 0);
    SetSceneMap(64, 1, 30, 24, 0);
    SetSceneMap(64, 1, 27, 31, 0);
    SetSceneMap(64, 1, 30, 30, 0);
    SetSceneMap(64, 1, 32, 31, 0);
    SetSceneMap(64, 1, 31, 28, 0);
    SetSceneMap(64, 1, 30, 32, 0);
    SetSceneMap(64, 1, 28, 37, 0);
