...
if a<=0 then
	...
	DarkScene();
	putscenemappro(4324*2,68,1,41,34);
	putscenemappro(3560*2,68,1,41,33);
	putscenemappro(1260*2,68,1,42,34);
	putscenemappro(1260*2,68,1,42,33);
	putscenemappro(1260*2,68,1,41,32);
	putscenemappro(2596*2,68,1,43,33);
	putscenemappro(3043*2,68,1,42,31);
	putscenemappro(3186*2,68,1,43,35);
	putscenemappro(3021*2,68,1,41,36);
	setsceneface(3);
	LightScene();
	Talk(0, "鐺鐺擋鐺鐺", -1, 1, 1, 0);
	Talk(0, "咦，那不是祖千秋和老頭子麼，他們怎麼在這兒呢。", -2, 0, 0, 0);
	scenefromto(43,29,43,34);
	Talk(106, "眾位鄉親父老，說到喝酒，大家一定不陌生吧，只是這喝酒呢，其實很有學問的。", -2, 0, 0, 0);
	Talk(107, "學問。", -2, 1, 0, 0);
	Talk(106, "祖某我從小到大，喝過的美酒無數，總結出了三條經驗，是為喝酒三法。", -2, 0, 0, 0);
	Talk(107, "那是哪三法呢？", -2, 1, 0, 0);
	Talk(106, "這一呢要符合好酒的原則、二呢符合喝酒的季節、三呢，那就是符合飲者的酒量了。", -2, 0, 0, 0);
	Talk(107, "哦，酒量。", -2, 1, 0, 0);
	Talk(106, "所謂三者兼備，喝酒才會有樂趣。俗語說的好，好酒入口一條線。", -2, 0, 0, 0);
	...
	Talk(106, "秋風起，易患疾，驅風定要喝花鵰。", -2, 0, 0, 0);
	...
	lightscene();
	Talk(0, "你們兩位還真有閒情逸致啊。", -2, 0, 0, 0);
	Talk(106, "原來是&&少俠啊，剛才你都看見了？", -2, 0, 0, 0);
	Talk(0, "是啊，想不到在這兒又領略了一番祖先生的三寸不爛之舌呢。", -2, 0, 0, 0);
	Talk(106, "這個麼，嘿嘿…", -2, 0, 0, 0);
	Talk(107, "一直在歸雲莊待著也有些悶得慌，老祖就提議出來胡亂耍耍，見笑了哈。", -2, 1, 0, 0);
	Talk(0, "哪裡哪裡，我可是乘機漲了不少見識呢。", -2, 0, 0, 0);
	Talk(107, "少俠又在為江湖事忙碌了吧，這兒還有幾壇酒，就送與少俠吧。", -2, 1, 0, 0);
	...
	darkscene();
	putscenemappro(0,68,1,41,34);
	putscenemappro(0,68,1,41,33);
	putscenemappro(0,68,1,42,34);
	putscenemappro(0,68,1,42,33);
	putscenemappro(0,68,1,41,32);
	putscenemappro(0,68,1,43,33);
	putscenemappro(0,68,1,42,31);
	putscenemappro(0,68,1,43,35);
	putscenemappro(0,68,1,41,36);
	lightscene();
end
exit();
