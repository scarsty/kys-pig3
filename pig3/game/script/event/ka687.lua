...
::label0::
    ...
    DarkScene();
    SetSceneMap(85, 1, 30, 27, 8652);
    SetSceneMap(85, 1, 30, 28, 8656);
    LightScene();
    ...
    DarkScene();
    SetSceneMap(85, 1, 30, 27, 0);
    SetSceneMap(85, 1, 30, 28, 0);
    SetSceneMap(85, 1, 30, 29, 8240);
    SetSceneMap(85, 1, 31, 29, 8654);
    SetSceneMap(85, 1, 29, 28, 2936);
    SetSceneMap(85, 1, 30, 28, 2938);
    SetSceneMap(85, 1, 31, 28, 2940);
    LightScene();
    ...
    SetSceneMap(85, 1, 30, 27, 8556);
    SetSceneMap(85, 1, 29, 25, 0);
    Talk(175, "先夫馬大元命喪你手，我跟你還有什麼故舊之情？只是小女子量淺不能喝盡，此後我與你生死大仇，有如此酒。（將殘酒潑在地下）", -2, 1, 0, 0);
    Talk(21, "……（一言不發，一飲而盡）", -2, 1, 0, 0);
    SetSceneMap(85, 1, 29, 25, 8556);
    SetSceneMap(85, 1, 30, 27, 8562);
    SetSceneMap(85, 1, 28, 25, 0);
    Talk(153, "……", -2, 1, 0, 0);
    Talk(21, "……（一言不發，一飲而盡）", -2, 1, 0, 0);
    SetSceneMap(85, 1, 28, 25, 8562);
    SetSceneMap(85, 1, 30, 27, 6266);
    SetSceneMap(85, 1, 30, 25, 0);
    Talk(153, "……", "陳孤雁", 11, 1, 0);
    Talk(21, "……（一言不發，一飲而盡）", -2, 1, 0, 0);
    SetSceneMap(85, 1, 30, 25, 6266);
    SetSceneMap(85, 1, 30, 27, 8554);
    SetSceneMap(85, 1, 33, 25, 0);
    Talk(180, "……", -2, 1, 0, 0);
    Talk(21, "……（一言不發，一飲而盡）", -2, 1, 0, 0);
    SetSceneMap(85, 1, 33, 25, 8554);
    SetSceneMap(85, 1, 30, 27, 7114);
    SetSceneMap(85, 1, 32, 25, 0);
    Talk(50, "幫主……", -2, 1, 0, 0);
...
::label5::
                        ...
                        SetSceneMap(85, 1, 33, 25, 0);
                        SetSceneMap(85, 1, 31, 25, 0);
                        SetSceneMap(85, 1, 30, 25, 0);
                        SetSceneMap(85, 1, 29, 25, 0);
                        SetSceneMap(85, 1, 28, 25, 0);
                        SetSceneMap(85, 1, 27, 25, 0);
                        SetSceneMap(85, 1, 30, 29, 0);
                        SetSceneMap(85, 1, 31, 29, 0);
                        SetSceneMap(85, 1, 29, 28, 0);
                        SetSceneMap(85, 1, 30, 28, 0);
                        SetSceneMap(85, 1, 31, 28, 0);
                        SetSceneMap(85, 1, 32, 31, 0);
                        SetSceneMap(85, 1, 30, 31, 0);
                        SetSceneMap(85, 1, 29, 31, 0);
                        SetSceneMap(85, 1, 31, 31, 0);
                        SetSceneMap(85, 1, 28, 31, 0);
                        SetSceneMap(85, 1, 26, 29, 0);
                        SetSceneMap(85, 1, 26, 28, 0);
                        SetSceneMap(85, 1, 26, 27, 0);
                        SetSceneMap(85, 1, 27, 29, 0);
                        SetSceneMap(85, 1, 27, 28, 0);
                        SetSceneMap(85, 1, 27, 27, 0);
                        ModifyEvent(85, 1, 1, 0, 688, 0, 0, 6416, 6416, 6416, 0, -2, -2);
                        ModifyEvent(85, 2, 1, 0, 689, 0, 0, 7014, 7014, 7014, 0, -2, -2);
                        SetScenePosition2(48, 31);
